...
- [x] **۲۵ عنوان فارسی واقعی** (تطبیق دقیق کد مدل، شاهد دیجی‌کالا) + **۲۵ عکس واقعی self-host** (`/images/products/ear-*.webp`، ≤۲۰۰KB)؛ ۲۵/۲۵ تصویر ۲۰۰ OK روی prod و ۲۵/۲۵ اتصال به کالا.
- [x] **پروب زنده Chromium+WebKit** روی صفحهٔ دسته: ۱۵ کارت با عکس واقعی، صفر placeholder، صفر تصویر شکسته، تک خطای کنسول = ۴۰۸ تایل نماد اعتماد (خارجی).
- [x] IndexNow: ۲۱۳ URL (شامل هر ۳۷ محصول با `lastmod 2026-09-16`) → ۲۰۰ OK.
- ⚠️ **باز:** تعداد موجودی همهٔ ۳۷ قلم روی **۲** ست شد (تنها شاهد: «۲» در انتهای لیست کاربر)؛ عکس ۱۲ مدل (`EH63, EH96, EH127, EH132, EH148, EH184, EH186, EH190, EH235, EH269, EH291, EH344`) موجود نیست؛ `features`/مشخصات فنی خالی (سند خصوصی است).
- جزئیات و مسیر بازتولید: `docs/REAL-INVENTORY-0916.md`.


## ⏸ PENDING (منتظر ورودی کاربر) — جایگزینی کاتالوگ تستی با لیست واقعی
**وضعیت:** کار قیمت‌گذاری/بازار متوقف شد (درخواست کاربر ۱۴۰۵/۰۶/۲۴: «استاپ کن تا فردا»). ۱۲۹ کالای باقی‌ماندهٔ prod **تستی** هستند (۱۳۸ منهای ۹ حذفی ۰۹۱۶) و با لیست واقعی جایگزین می‌شوند؛ بخش **هولدر** در ۱۴۰۵/۰۶/۲۵ با موجودی واقعی بارگذاری شد (بالا).
