...
d = ImageDraw.Draw(img)
center(d, 55, fa("نوین خودرو | خرید از شما، اقساط از ما"), font(T_BOLD, 46), (148, 163, 184))
center(d, 150, fa("هم امروز بخر، اقساط از دیماه"), font(T_BLACK, 88), (255, 255, 255))
# red underline accent
d.rounded_rectangle([(W-170)/2, 290, (W+170)/2, 304], radius=7, fill=(220, 38, 38))
center(d, 335, fa("اقساط ۶ تا ۲۴ ماهه • کارشناسی ۱۰۰٪ تخصصی"), font(T_BOLD, 52), (226, 232, 240))
center(d, 430, fa("خرید نقد و اقساطی | فروش خودروی شما | مشاوره تخصصی"), font(T_BOLD, 36), (148, 163, 184))
center(d, 515, fa("۰۲۱ - ۶۶۱۲۰۳۳۲ • تهران"), font(T_BOLD, 40), (96, 165, 250))
...
d = ImageDraw.Draw(img)
center(d, 80, fa("جانبی آرنا"), font(T_BLACK, 100), (255, 255, 255))
center(d, 225, fa("فروشگاه آنلاین لوازم جانبی موبایل"), font(T_BOLD, 52), (244, 124, 32))
d.rounded_rectangle([(W-150)/2, 330, (W+150)/2, 344], radius=6, fill=(244, 124, 32))
center(d, 375, fa("کاور • گلس • شارژر اورجینال • پاوربانک"), font(T_BOLD, 46), (226, 232, 240))
center(d, 465, fa("ضمانت اصالت کالا | ارسال سریع | گارانتی معتبر"), font(T_BOLD, 36), (148, 163, 184))
center(d, 540, fa("janebiarena.ir"), font(T_BOLD, 40), (96, 165, 250))
