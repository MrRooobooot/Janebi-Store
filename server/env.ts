...
const envSchema = z.object({
  ...
  JWT_ACCESS_SECRET: z.string().min(10, 'JWT_ACCESS_SECRET must be at least 10 characters long').default('development_jwt_access_secret_key_2026'),
  JWT_REFRESH_SECRET: z.string().min(10, 'JWT_REFRESH_SECRET must be at least 10 characters long').default('development_jwt_refresh_secret_key_2026'),
