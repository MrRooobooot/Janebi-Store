      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 mb-10 items-stretch">
          ...
          <div className="lg:col-span-4 space-y-4 text-right flex flex-col justify-between">
            <div>
              <h4 className="text-base font-black text-gray-900 dark:text-gray-100 mb-2">فروشگاه اینترنتی جانبی آرنا</h4>
            ...
            <div className="space-y-2 text-xs text-gray-600 dark:text-gray-400 pt-2 font-medium border-t border-gray-100 dark:border-gray-800/60">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between bg-gradient-to-r from-orange-50 to-amber-50 dark:from-gray-800/80 dark:to-gray-800/40 p-6 rounded-3xl border border-orange-100/80 dark:border-gray-700/60 text-right">
            <div>
              <h4 className="text-base font-black text-gray-900 dark:text-gray-100 mb-1">عضویت در خبرنامه جانبی آرنا</h4>
            ...
            <form onSubmit={handleSubscribe} className="flex w-full mt-4">
              <input 
                ...
                className="grow bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-r-2xl px-4 py-3 focus:outline-none focus:border-orange-500 dark:focus:border-orange-400 text-left dir-ltr text-xs text-gray-800 dark:text-gray-200 placeholder:text-gray-400 dark:placeholder:text-gray-500"
                required
              />
          ...
          <div className="md:col-span-2 lg:col-span-3 flex flex-col items-center justify-center p-6 rounded-3xl bg-white dark:bg-gray-800/50 border border-gray-200/80 dark:border-gray-700 shadow-xs text-center">
            ...
            <a
              ...
              className="w-28 h-28 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-gray-700 flex items-center justify-center p-2 shadow-inner hover:scale-105 transition-all duration-300 relative group overflow-hidden"
            >
              {!imgLoaded && !imgError && (
