    ...
    <div className="flex flex-col h-full bg-zinc-50/95 dark:bg-zinc-900/60 backdrop-blur-xl border-l border-zinc-200/80 dark:border-zinc-800">
      ...
      <div className="p-5 border-b border-zinc-200/80 dark:border-zinc-800 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="w-11 h-11 flex items-center justify-center rounded-xl text-zinc-500 hover:text-[var(--color-emphasis-text)] hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors motion-reduce:transition-none"
          ...
          <button
            ...
            aria-label="بستن منو"
            className="lg:hidden w-11 h-11 flex items-center justify-center text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-200"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
              ...
              className={({ isActive }) => 
                `flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs font-bold transition-all ${
                  isActive 
                    ...
                    : 'text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100/80 dark:hover:bg-zinc-800/60 hover:text-[var(--color-text-main-light)] dark:hover:text-zinc-100'
                }`
              }
            >
      ...
      <div className="p-3 border-t border-zinc-200/80 dark:border-zinc-800 space-y-1.5">
        <Link
          to="/"
          target="_blank"
          className="flex items-center justify-between w-full px-3.5 py-2 text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-xl text-xs font-bold transition-all"
        >
      ...
      <div className="flex-1 lg:mr-64 flex flex-col min-w-0">
        ...
        <header className="lg:hidden bg-zinc-50/90 dark:bg-zinc-900/60 backdrop-blur-xl border-b border-zinc-200/80 dark:border-zinc-800 p-3.5 flex items-center justify-between sticky top-0 z-20 shadow-xs">
          ...
          <button
            onClick={toggleTheme}
            aria-label={isDarkMode ? 'تغییر به حالت روز' : 'تغییر به حالت شب'}
            className="w-11 h-11 flex items-center justify-center rounded-xl text-zinc-500 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors motion-reduce:transition-none"
          >
