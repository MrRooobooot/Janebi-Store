                ...
                <span
                  className={`w-10 h-10 rounded-full flex items-center justify-center text-base transition-colors ${
                    isCurrent
                      ...
                      : 'bg-[var(--color-surface-light)] dark:bg-[var(--color-surface-dark)] border-2 border-[var(--color-border-light)] dark:border-[var(--color-border-dark)] text-zinc-500 dark:text-zinc-400 font-bold'
                  }`}
                >
